...
<head>
    ...
    <title>Koperasi Wanita Jasmine Sejahtera</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href={{ asset("/img/koperasi.png") }}>
    <!-- Custom Stylesheet -->
    <link href="https://cdn.quixlab.com/fonts/feather/feather.min.css" rel="stylesheet">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <!--**********************************
            Nav header end
        ***********************************-->
        @include('ketua.layouts.partials.nav')
        <!--**********************************
            Header start
        ***********************************-->
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
       @include('ketua.layouts.partials.side')
        <!--**********************************
            Sidebar end
        ***********************************-->
        ...
        ***********************************-->
        ...
        <!--**********************************
            Footer start
        ***********************************-->
        @include('ketua.layouts.partials.footer')
        <!--**********************************
            Footer end
        ***********************************-->
    </div>
